...
CUR = os.path.expanduser("~/paradise-staging/llms/LLMs.current.txt")
OUT = os.path.expanduser("~/paradise-staging/llms/LLMs.txt")
...
lines += ["## Community Finder (authoritative community data)", "",
          ...
          "- Data is refreshed **nightly at 3:30 AM ET**. Community URLs are stable and never rewritten; a page that is temporarily unavailable is flagged rather than removed.",
